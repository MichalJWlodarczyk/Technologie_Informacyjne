...
\begin{figure}[ht]
\centering
\includegraphics[scale=0.6]{Obrazy/Wrocław w 12-13wieku.png}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=0.4]{Obrazy/Wrocław kosciol św.Idziego.jpg}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=1.2]{Obrazy/Wrocław Breslau.jpg}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=1.2]{Obrazy/Wrocław Merian.jpg}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=0.6]{Obrazy/Wrocław Breslau 2.jpg}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=3.6]{Obrazy/Wrocław Brama.jpg}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=1.2]{Obrazy/Wrocław Napoleon.png}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=0.7]{Obrazy/Wrocław Odra.jpg}
...
\includegraphics[scale=0.8]{Obrazy/Wrocław mapa 2.jpg}
\end{adjustwidth}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=0.4]{Obrazy/Wrocław rozkwit mapa.jpg}
...
\begin{figure}[h!]
\centering
\begin{adjustwidth}{-1.6in}{-.5in}  
\includegraphics[scale=1.9]{Obrazy/Wrocław mapa 3.jpg}
\end{adjustwidth}
...
\includegraphics[scale=0.7]{Obrazy/Wrocław oblężenie.jpg}
\end{adjustwidth}
...
Pod koniec wojny zbliżający się ze wschodu front spowodował, że trafiła tu kilkusettysięczna fala uciekinierów z Górnego Śląska[e]. W sierpniu 1944 miasto zostało ogłoszone twierdzą (Festung Breslau) i otrzymało rozkaz bronienia się do ostatniego żołnierza\footnote{bonczek/hydroforgroup: 1945 – Festung Breslau. W: Wratislaviae Amici [on-line]. [dostęp 2008-12-18].}.
...
\centering
\begin{adjustwidth}{-.5in}{-.5in}  
\includegraphics[scale=1.7]{Obrazy/Wrocław willa.jpg}
\end{adjustwidth}
\caption{Villa Colonia. Miejsce podpisania kapitulacji Wrocławia\footnote{Elżbieta Osowicz: Villa Colonia: Tutaj poddał się Breslau. 2013-12-19. s. Radio Wrocław. [dostęp 2017-11-15].}}
\label{fig:oblężenie}
\end{figure}
...
\centering
\begin{adjustwidth}{-.5in}{-.5in}  
\includegraphics[scale=.4]{Obrazy/Wrocław tablica.jpg}
\end{adjustwidth}
\caption{Oblężenie Wrocławia – 6 maja 1945}
\label{fig:oblężenie}
\end{figure}
...
\centering
\begin{adjustwidth}{-.4in}{-.5in}  
\includegraphics[scale=.6]{Obrazy/Wrocław Kongres.png}
\end{adjustwidth}
...
\centering
\begin{adjustwidth}{-.7in}{-.5in}  
\includegraphics[scale=.5]{Obrazy/Wrocław wjazd.png}
\end{adjustwidth}
...
\begin{figure}[h!]
\centering
\begin{adjustwidth}{-.9in}{-.5in}  
\includegraphics[scale=.6]{Obrazy/Wrocław Panorama.jpg}
\end{adjustwidth}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=.8]{Obrazy/Wrocław Krasnal.jpg}
